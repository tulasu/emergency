...
ACT_PATTERNS = {
    ...
    "успокоение": r"\b(успокой|не паник|оставайтесь|остаться на месте|остаться на линии|не кладите|не вешайте|ждите)",
...
# по границам слов: подстрока ловила «чТО ЕСТЬ рядом» как «то есть»
...
class Lexical:
    ...
    def understand(self, text: str) -> Understanding:
        ...
        for seg in morph.segments(text):
            ...
            # одни местоимения темы не задают: «как у вас дела» — не вопрос
            # о местоположении заявителя
            ...
            if said:
                # ponytail: число в реплике бьёт вес — «тринадцатый, верно?»
                # должен выбрать этаж возгорания, а не этажность дома
